...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.CardViewHolder> {
    ...
    private SearchMvpPresenter mPresenter;

    public SearchAdapter(Context context, SearchMvpPresenter presenter) {
    ...
    @Override
    public SearchAdapter.CardViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.feed_card_layout, parent, false);
        SearchAdapter.CardViewHolder cardViewHolder = new SearchAdapter.CardViewHolder(view);
        return cardViewHolder;
    }
    @Override
    public void onBindViewHolder(SearchAdapter.CardViewHolder holder, int position) {
    ...
    public class CardViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final FeedCardData cardData, final SearchMvpPresenter processPresenter) {
